class CreateBulletins < ActiveRecord::Migration[5.1]
  def change
    create_table :bulletins do |t|
      ...
      t.boolean :opt_hashtag, default: true # 해시태그
      t.boolean :opt_post_vote, default: false # 게시글 투표
      t.boolean :opt_comment_vote, default: false # 댓글 투표
      t.boolean :opt_card, default: false # 카드형식 목록
      t.boolean :opt_agenda, default: false # 안건
      t.boolean :opt_shop, default: false # 상점
